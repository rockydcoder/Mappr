...
public class BehaviourActivity extends ActionBarActivity{
   /* private NavigationDrawerFragment mNavigationDrawerFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPager = (ViewPager) findViewById(R.id.pagerBehav);

        mPager.setAdapter(new MyPagerAdapter(getSupportFragmentManager()));
        mTabs = (SlidingTabLayout) findViewById(R.id.tabsBehav);
    ...
    class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch(position) {
                ...
                case 1:
                    return new StudentOfFragment();
                case 2:
                    return new BehaviourReportForFragment();
