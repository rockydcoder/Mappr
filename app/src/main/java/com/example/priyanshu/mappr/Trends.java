 ...
 */
public class Trends extends ActionBarActivity{
    ...
    class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch(position) {
                ...
                case 1:
                    return new ChngInPerfFragment();
                case 2:
                    return new CompPerfFragment();
                case 3:
                    return new BestPerfFragment();
                case 4:
                    return new MostActExtCurFragment();
                case 5:
                    return new BehvTrendsFragment();
            }
